...
namespace UnifiedMarketplace.Controllers
{
    public class VendedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RazaoSocial,NomeFantasia,Cnpj,Email,Senha,Comissao")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RazaoSocial,NomeFantasia,Cnpj,Email,Senha,Comissao")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
