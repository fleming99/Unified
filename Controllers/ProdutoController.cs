...
namespace UnifiedMarketplace.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Preco,Imagem,Status")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Preco,Imagem,Status")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
