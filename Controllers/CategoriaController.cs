...
namespace UnifiedMarketplace.Controllers
{
    public class CategoriaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoriaNome,Descricao")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoriaNome,Descricao")] Categoria categoria)
        {
            if (id != categoria.Id)
            {
                return NotFound();
