...
namespace UnifiedMarketplace.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cpf,Email,Senha")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cpf,Email,Senha")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
